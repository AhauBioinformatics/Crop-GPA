...
if __name__ == '__main__':
    ...
    np.savez_compressed('C:/Users/Administrator/Desktop/GCNFTG CODE/miRNA_disease__case_study/task_Tp_balanced_10knn_lr0.01_weight10_fold0.npz', ys_train = ys_train, ys_test = ys_test)
